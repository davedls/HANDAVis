...
<header class="main-header responder-main-header">
  ...
  <div class="header-right">
    ...
    <button type="button" class="icon-btn" onclick="openResponderProfile()" title="Profile">
...
<div class="mobile-drawer" id="mobileDrawer">
  ...
  <button type="button" class="mobile-drawer-item" onclick="openResponderProfile();toggleHamburger()">
