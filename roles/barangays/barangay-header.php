...
<header class="main-header barangay-main-header">
  ...
  <div class="header-right">
    ...
    <button type="button" class="icon-btn" onclick="openBarangayProfile()" title="Profile">
...
<div class="mobile-drawer" id="mobileDrawer">
  ...
  <button type="button" class="mobile-drawer-item" onclick="openBarangayProfile();toggleHamburger()">
